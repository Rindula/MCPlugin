...
public class TeleportCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		...
		if (!sender.hasPermission("test.tp")) {
			m.sendError(sender, "Du darfst den Befehl nicht ausführen");
			return true;
		}
		...
		if (sender instanceof Player) {
			...
			PotionEffect effect2 = new PotionEffect(PotionEffectType.GLOWING, time + 10, 1);
			...
			case 2:
				...
				if (!t1.isInsideVehicle())
					t1.addPotionEffect(effect, true);
				t1.addPotionEffect(effect2, true);
			...
			case 4:
				...
				if (!tg1.isInsideVehicle())
					tg1.addPotionEffect(effect, true);
				tg1.addPotionEffect(effect2, true);
